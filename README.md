...
- 6 类栏目页、24 位教师详情页与 13 个合作机构详情页均提供中英文版本，共 86 个正文 URL。
...
英文栏目页在对应路径前添加 `/en`。教师详情使用 `/teachers/<slug>/` 与 `/en/teachers/<slug>/`，合作机构详情使用 `/partners/<slug>/` 与 `/en/partners/<slug>/`。所有正文 URL 均使用尾斜杠。
